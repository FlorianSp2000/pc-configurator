...
export default {
  ...
  data() {
    return {
      ...
      show_config: false,
      name: "",
      description: "Schreibe zu jeder deiner Konfigurationen eine kurze Beschreibung - Wofür eignet sich diese besonders gut?",
    }
  },
  created() {
    ...
    const promise4 = axios.get('http://localhost:5000/api/motherboard');
    const promise5 = axios.get('http://localhost:5000/api/disk_storage');
